      ...
      <div class="row">
        <div class="col-12 col-md-6">
          ...
          <div class="navbar-lang">
            <div class="dropdown meat_top_bar">
              <ul>
                <li>Welcome to NICE2MEATU Store</li>
                <li>
                    <span>Call Us:</span>
                    <a class="nav-link right-menu" href="tel:+91 73822 73824" style="color:#fff;padding-left: 5px;">
                        <i class="fas fa-phone-alt"></i>+91 73822 73824
                    </a>
                </li>
              </ul>
            </div>
